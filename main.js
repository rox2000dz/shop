...
const talabtRoom = "1301612858575949924" //ايدي روم طلبات 
const emjTrue = "✅" //حط اموجي الصح 
const emjFalse = "❌" //حط اموجي الغلط   
const montagat = "1301612859712864266" // ايدي روم منتجات
const staffManagerRole = "1301612859712864266"//ايدي رتبه اداره
const discorsLeader = "1301612761633128520"//ايدي رتبه اداره
const OfficialRole = "1301612859712864266"//ايدي رتبه اداره
const discordstaff = "1301612859712864266"//ايدي رتبه اداره
const RolesRole = "1301612859712864266" //ايدي رتبه اداره
const allowedRole = "1301612859712864266" //ايدي رتبه اداره
const lineLink = "https://cdn.discordapp.com/attachments/1301612873969045565/1304727117564481576/66041_4-1.jpg?ex=67307151&is=672f1fd1&hm=0926eec7dd95976536c8aba3645b8060287ee5442465563c70b5d7b8b3ceca2d&" // رابط الخط 
...
////////////////// كود خط تلقائي 
      ...
      let autoline_channel = ['1301612841757052960','1301612840880177244','1301612845967867954','1301612843090710630','1301612848388112384','1301612847276757002','1301612850812293163','1301612849616916512','1301612851559010337',''] // ايدي الرومات بيع (تقدر تضيف اكثر من روم)
      let line = `https://cdn.discordapp.com/attachments/1301612873969045565/1304727117564481576/66041_4-1.jpg?ex=67307151&is=672f1fd1&hm=0926eec7dd95976536c8aba3645b8060287ee5442465563c70b5d7b8b3ceca2d&` //رابط الخط
...
const TaxChannel = "1301612854587162625" //ايدي روم ضرائب
...
////////////////// كود نداء شخص
  ...
  client.on('messageCreate', async message => {
  const allowedRoles = ['1301612778699620362']; //ايدي رتبه تقدر تستعمل الامر
...
client.on('messageCreate', async (message) => {
  if (message.content === prefix + 'ping') {
    const member = message.member;
    const allowedRole = message.guild.roles.cache.find(role => role.name === '1301612761633128520'); //اسم رتبه يلي تقدر تستعمل امر
 ...
 let ping = client.ws.ping
    ...
    let embed = new MessageEmbed()
        ...
        .setColor('#878787')
        .setThumbnail("https://cdn.discordapp.com/attachments/1301612873969045565/1304727117564481576/66041_4-1.jpg?ex=67307151&is=672f1fd1&hm=0926eec7dd95976536c8aba3645b8060287ee5442465563c70b5d7b8b3ceca2d&`")
...
client.on('interactionCreate', async interaction => {
    var member;
    let role = interaction.guild.roles.cache.find(role => role.id === "1301612778699620362"); // ايدي رول اللى يستلم التكت
    if(interaction.isButton){

        if(interaction.customId === `idk`){
          if(interaction.member.roles.cache.some(role => role.id === "1301612778699620362")) // حط هنا ايدي الرتبة اللى تستلم التكت
            {
        ...
        db.add(`alluser_${interaction.member.id}`, 1)
          ...
          const everyone = interaction.guild.roles.cache.find(r => r.name === "♛ || Staff");//اسم رتبه اداره
          let l1 = interaction.user;
           ...
           collector.on('collect', async i => {
            ...
            if(interaction.member.roles.cache.some(role => role.id === "1301612778699620362")) //ايدي رتبة اداره
              {
               ...
               interaction.channel.send({ content: `${role}` , embeds: [embed], components: [product]});
                const everyone = interaction.guild.roles.cache.find(r => r.name === "♛ || Staff"); //اسم رتب اداره
...
interaction.channel.setName("ticket-" + interaction.user.username);                interaction.channel.permissionOverwrites.edit(role,{SEND_MESSAGES: true})
          ...
          interaction.channel.permissionOverwrites.edit('1301612761633128520',{SEND_MESSAGES: false}) //ايدي رتبه يلي تقدر ترسل بعد احد يستلم تكت
          interaction.channel.permissionOverwrites.edit('1301612778699620362',{VIEW_CHANNEL: true}) //ايدي رتبه يلي ماتقدر ترسل بعد احد يستلم تكت
          }else{
            interaction.followUp({ 
                content: `ماشفتك تستخدم الزر ؟`,
                ephemeral: true 
...
client.on("messageCreate", async message => {
  if (message.content.startsWith(prefix + "addticket")) {
    if (message.member.roles.cache.some(r=> r.id == 1301612756041994393)) { //ايدي رتبه تقدر تستعمل الامر 
    ...
    if (message.content.startsWith(prefix +'start')) {
        ...
        try {
            ...
            memberList.forEach(async (member) => {
                if (member.roles.cache.has('1301612778699620362')) {  //discord staff
                   const db = require("pro.db");
                    ...
                    var roleToAssignHighStaff = "1301612778699620362"; // ايدي رتبه اداره
                   if (!member.roles.cache.some(r => r.id == 1301612778699620362)) { //ايدي رتبة اداره
...
client.on("messageCreate", async message => {
  ...
  if (message.content.startsWith(prefix + "mute")) {
    ...
    let channel = message.guild.channels.cache.get("1301612858575949924"); //ايدي روم طلبات 
...
const channelID = message.guild.channels.cache.get('13016128708442849')// روم لوق 
        ...
        let row1 = new MessageActionRow()
          .addComponents(
            new MessageSelectMenu()
              ...
              .addOptions([
                {
                  label: 'Mythic', //اسم رتبه 
                  value: '1301612782319435798' //ايدي رتبه
                },
                {
                  label: 'Special',//اسم رتبه 
                  value: '1301612783367880725'//ايدي رتبه
                },
                {
                  label: 'Great',//اسم رتبه 
                  value: '1301612784525643788'//ايدي رتبه
                },
                {
                  label: 'The Develpor',//اسم رتبه 
                  value: '1301612785351790644'//ايدي رتبه
                },
                {
                  label: 'Designer',//اسم رتبه 
                  value: '1301612786459086891'//ايدي رتبه
                },
                {
                  label: 'Demon',//اسم رتبه 
                  value: '1301612787251810305'//ايدي رتبه
                },
                {
        ...
        let row1 = new MessageActionRow()
          .addComponents(
            new MessageSelectMenu()
              ...
              .addOptions([
                {
                  label: "Exclusive",//اسم رتبه 
                  value: "1301612780528472157",//ايدي رتبه
                },
                {
                  label: "KingPlace",//اسم رتبه 
                  value: "1301612781031784459",//ايدي رتبه
                },
                {
                  label: "لا يوجد",//اسم رتبه 
                  value: "لا يوجد",//ايدي رتبه
...
client.on('messageCreate', async message => {
  if (message.content.startsWith(prefix + 'crook') && message.member.roles.cache.has(OfficialRole)) {
    ...
    const role = guild.roles.cache.get('1301612750081888276'); //ايدي رتبه تقدر تستعمل امر 
    const logChannel = await message.client.channels.fetch("1301612816624648193");//ايدي روم  تشهير 
    const args = message.content.split(' ');
    const user = message.mentions.members.first() || message.guild.members.cache.get(args[1]);
    if (!user) return message.reply(`**منشن الشخص أولاً أو ضع الإيدي !**`)
     const db = require("pro.db");
...
client.on('messageCreate', async message => {
  if (message.content.startsWith(prefix + 'examine') || message.content.startsWith('فحص')) {
    ...
    if (db.has(`scammer_${user.id}`)) {
      ...
      await message.reply(`**هذا الشخص ليس نصاب <  ، لكن انتبه ! هذا لا يعني أنه مضمون .. الرجاء أخذ وسيط  من هنا https://discord.gg/zo2  قبل التعامل مع أي أحد . **`);
    }
  }
});
...
client.on("guildMemberAdd", async member => {
  ...
  const role = guild.roles.cache.find(r => r.name === "1304732012304666745");//اسم رتبه يلي يعطيها بعد تسوي لي شخص تشهير
  ...
  if (message.content.startsWith(prefix +'top') || message.content.startsWith(prefix +'توب')) {
    try {
      ...
      memberList.forEach((member) => {
        if (member.roles.cache.has('1301612778699620362')) {//ايدي رتبه اداره
           const db = require("pro.db");
...
client.on("messageCreate", async message => {
  ...
  if (message.content.startsWith(prefix + 'sub')) {
    if (message.member.roles.cache.some(r => r.id == 1301612761633128520)) { //ايدي رتبه تقدر تستعمل امر 
      let prv = message.guild.roles.cache.find(r => r.id == 1301612788413632673) //ايدي رتبه يلي يعطيها للشخص بعد روم خاص 
...
`)
      ...
      let mm = await message.guild.channels.create(`〢↬・${member.user.username}`, { type: "text" })
        .then(async m => {
          m.setParent(message.guild.channels.cache.find(r => r.id == 1301612804515565598)) //ايدي كتالوجي يلي يفتح فيه رومات
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (interaction.customId === "apply") {
    ...
    if (
      interaction.member.roles.cache.some((r) => r.id == 1301612778699620362) || //ايدي رتبة اداره
      interaction.member.roles.cache.some((r) => r.id == 1301612778699620362) //ايدي رتبة اداره
    )
      return interaction.reply({
...
client.on("interactionCreate", (interaction) => {
  if (interaction.isButton()) {
    if (interaction.customId == "acc") {
      if (
        !interaction.member.roles.cache.some((r) => r.id == 1301612756041994393) // ايدي رتبه تقدر تقبل ناس 
      )
        return interaction.reply({
      ...
      let role = interaction.guild.roles.cache.find(
        (r) => r.id == "1301612778699620362" //ايدي رتبه يلي تجي للشخص بعد قبول 
      );
      let embed = new MessageEmbed()
    ...
    if (interaction.customId == "dec") {
      if (
        !interaction.member.roles.cache.some((r) => r.id == 1301612756041994393)//ايدي رتبه تقدر ترفض ناس 
      )
        return interaction.reply({
          content: "**ما تقدر تستعمل هذا الامر**",
          ephemeral: true,
    ...
    if (interaction.customId == "time") {
      if (
        !interaction.member.roles.cache.some((r) => r.id == 1301612778699620362) //ايدي رتبه يلي تقدر تعطي ميوت
      )
        return interaction.reply({
          content: "**ما تقدر تستعمل هذا الامر**",
          ephemeral: true,
...
const logsChannelId = "1301612839709970557"; // قناة اللوج (تم تغيير اسم المتغير إلى logsChannel)
const warnFile = './Warnings.json'; // ملف لتخزين التحذيرات

// تعريف رولات التحذيرات
const firstWarnRoleId = "1302255314753552424"; // رول التحذير الأول
const secondWarnRoleId = "1302255348207583263"; // رول التحذير الثاني
const thirdWarnRoleId = "1302302717573599357"; // رول التحذير الثالث
...
client.on("messageCreate", async message => {
  ...
  if (!message.content.startsWith(prefix)) return; // التأكد من أن الرسالة تبدأ بالبريفكس

  const args = message.content.slice(prefix.length).trim().split(/ +/);
  const command = args.shift().toLowerCase();

  // التأكد من أن الشخص الذي يستخدم الأمر لديه صلاحيات (الرولات المحددة)
  const allowedRoles = ["1301612761633128520", "1301612778699620362"]; // رولات الإدارة
  ...
  if (command === "تحذير") {
    ...
    if (!user) return message.reply("**يرجى منشن الشخص أولاً!**");

    const reason = args.slice(1).join(" ");
    if (!reason) return message.reply("**يرجى إدخال السبب!**");

    if (!message.attachments.size) {
      return message.reply("**يرجى إرسال صورة كدليل!**");
    }

    // تحميل دليل الصورة
    const attachments = Array.from(message.attachments.values()).map(attachment => attachment.url);

    // قراءة البيانات من ملف Warnings.json
    let warnings = JSON.parse(fs.readFileSync(warnFile));

    // إذا لم يكن الشخص قد تم تحذيره من قبل
    if (!warnings[user.id]) {
      warnings[user.id] = { count: 0, warns: [], userInfo: { id: user.id, username: user.user.username } };
    }

    warnings[user.id].count++;

    // إضافة التحذير في سجل التحذيرات
    warnings[user.id].warns.push({
    ...
    // تحديد نوع التحذير (أول أو ثاني أو ثالث)
    const warnType = warnings[user.id].count === 1 ? "أول" : warnings[user.id].count === 2 ? "ثاني" : "ثالث";
    const warnRole = warnings[user.id].count === 1 ? firstWarnRoleId : warnings[user.id].count === 2 ? secondWarnRoleId : thirdWarnRoleId;

    // إضافة الرول المناسب بناءً على التحذير
    if (warnings[user.id].count === 1) {
      user.roles.add(firstWarnRoleId);  // إضافة رول التحذير الأول
    } else if (warnings[user.id].count === 2) {
      user.roles.add(secondWarnRoleId);  // إضافة رول التحذير الثاني
    } else if (warnings[user.id].count === 3) {
      user.roles.add(thirdWarnRoleId); // إضافة رول التحذير الثالث
    }

    // إنشاء الرسالة
    const warningMessage = `**__
<:emoji_2:1302304087362240522> تم تحذير: ${user}

<:emoji_2:1302304087362240522> الإداري: ${message.author}

<:emoji_2:1302304087362240522> نوع التحذير: ${warnType}
<@&${warnRole}>

<:emoji_2:1302304087362240522> عدد التحذيرات: ${warnings[user.id].count}

<:emoji_2:1302304087362240522> السبب: ${reason}

<:emoji_2:1302304087362240522> الدليل: ${attachments.length ? attachments.join("\n") : "لا يوجد دليل"}

__**`;

    // إرسال رسالة التحذير في القناة
    message.reply(warningMessage);

    // إرسال التحذير إلى قناة اللوج (logsChannel)
    const logsChannel = message.guild.channels.cache.get(logsChannelId);
    logsChannel.send(warningMessage);

    // حفظ التحذيرات في ملف Warnings.json
  ...
  if (command === "تحذيرات") {
    ...
    // قراءة التحذيرات من ملف Warnings.json
    let warnings = JSON.parse(fs.readFileSync(warnFile));

    // التحقق إذا كان الشخص قد تم تحذيره
    if (!warnings[user.id] || warnings[user.id].count === 0) {
      return message.reply("**هذا الشخص ليس لديه أي تحذيرات!**");
    }

    let warnListMessage = `**تحذيرات لـ ${user.tag} (${user.user.username})**\n
**عدد التحذيرات:** ${warnings[user.id].count}`;

    // إضافة تفاصيل التحذيرات في الرسالة
    warnings[user.id].warns.forEach((warn, index) => {
      warnListMessage += `
      **تحذير ${index + 1}:**
      **المسؤول:** ${warn.admin}
      **السبب:** ${warn.reason}
      **الوقت:** ${new Date(warn.time).toLocaleString()}
      **الدليل:** ${warn.image.length ? warn.image.join("\n") : "لا يوجد دليل"}`;
    });

    message.reply(warnListMessage);
  }
});
...
const options = ['100k', '150k', '500k', 'nitro 1 month','Great S']; // الجائزة
...
let sug = ["1304743849033207948", "", ""]; // حط اي دي روم الاقتراحات
let linee = "https://cdn.discordapp.com/attachments/1301612873969045565/1304743984152838175/66041_4-1-1.jpg?ex=67308106&is=672f2f86&hm=8773f76a0d23a9853f7c09e0b64e034d94b20bd77080ebfa2a294ab73162e4c3&"; // رابط الخط
...
client.on("messageCreate", async (message) => {
  ...
  if (args[0].toLowerCase() === prefix + "مسح") {
                                      // ايدي رتبه تقدر تستعمل الامر
    if (!message.member.roles.cache.has(1301612750081888276) && !message.member.permissions.has("ADMINISTRATOR")) return;
...
**ملاحظات :**
- لطلب رتبة يرجى التواصل مع  يرجى التوجه الى: : <#1301612863089020959> 
- التحويل لـ : <@1297968745305604097> 
...
- منشن ايفري مرة باليوم بروم <#1301612840880177244> 
- منشور مميز كل 5 ايام
- نشر كل ساعه بروم <#1301612840880177244>
...
- إمكانية نشر الصور بكل الرومات
- إمكانية المنشن هير بكل الرومات
- منشن ايفري ون مرتين باليوم بروم <#1301612840880177244>
- منشور مميز كل يومين
- خصم 50% على الاعلانات بدون قيف اواي
- نشر كل ساعة بروم <#1301612840880177244>

**ملاحظات :**
- لطلب رتبه يرجى التوجه الى: : <#1301612863089020959> 
- التحويل لـ : <@1297968745305604097> 
- ان قمت بالتحويل لشخص غير الحساب المذكور اعلاه فلن يتم تسليمك الرتبة و لن نتحمل المسؤولية`)
.setColor(colorE)
.setImage('')
...
- لطلب روم يرجى التوجه الى : <#1301612863089020959>
- التحويل لـ : <@1297968745305604097>
...
**ملاحظات : **
- لطلب اعلان يرجى التواصل مع : <#1301612863089020959>
- التحويل لـ : <@1297968745305604097>
...
**ملاحظات :**
لطلب منشور يرجى التواصل مع : <#1301612863089020959>
- التحويل لـ : <@1297968745305604097>
...
let log = client.channels.cache.get("1301612870139773021") // ايدي روم الوق
...
let role = "1301612790636744704"//ايدي الرول يلي تنعطى للشخص
...
if(!mesg.member.roles.cache.find((role) => role.id=== '1301612750081888276')) //ايدي رول الي يقدر يتحكم
return mesg.reply({embeds:[permissions]})
let men = mesg.guild.roles.cache.find(role => role.id === '1301612790636744704'); //ايدي رول الممبر
if(!men) return;
let C1 = client.channels.cache.get(`1301612781031784459`,`1301612780528472157`); //Vip
let C2 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612784525643788`,`1301612787251810305`); //acc
let C3 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612784525643788`,`1301612787251810305`);  //dis
let C4 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612786459086891`); //des 
let C5 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612785351790644`); 
//dev
let C6 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612784525643788`,`1301612787251810305`); 
//trq
let C7 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612784525643788`,`1301612787251810305`); 
//coins
let C8 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612784525643788`,`1301612787251810305`);
//gim
let C9 = client.channels.cache.get(`1301612782319435798`,`1301612780528472157`,`1301612781031784459`,`1301612783367880725`,`1301612784525643788`,`1301612787251810305`);
//other
...
let news = client.channels.cache.get(`1301612827919912999`);// ايدي الروم الي ينشر فيه حالة النشر
...
let mn = '1304752855412113408';/// ايدي رول الي تتمنشن في روم المنتجات

let br = '1304752855412113408';/// ايدي رول الي تتمنشن في روم البرمجيات

let ta = '1247712444944748574'; /// ايدي رول الي تتمنشن في روم التصاميم

const targetRoleId = '1304752920948117535'; /// ايدي الرول الي تحذف الطلبات
const logChannelId = '1301612870139773021'; /// لوق حذف التصاميم
const brmjeatID = '1301612870139773021'; /// لوق حذف برمجيات
const logmntgatID = '1301612870139773021'; /// لوق حذف منتجات
...
- يرجى مراجعة القوانين في <#1301612838867177565> قبل الطلب لتجنب المخالفة
...
client.on('interactionCreate', async (i) => {
  ...
  if (i.customId === 'myButton') {
    ...
    const sl = `<@&${ta}> - ${mention}`;
    const channel = await client.channels.fetch('1301612860782153760'); // روم تصاميم
   ...
   await channel.send({ content: `https://cdn.discordapp.com/attachments/1301612873969045565/1304743984152838175/66041_4-1-1.jpg?ex=67308106&is=672f2f86&hm=8773f76a0d23a9853f7c09e0b64e034d94b20bd77080ebfa2a294ab73162e4c3&` });/////خط
...
client.on('interactionCreate', async (i) => {
  ...
  if (i.customId === 'myButton1') {
    ...
    const kl = `<@&${br}>- ${mention}`;
    const channel = await client.channels.fetch('1301612861554036747');///////ايدي روم البرمجيات
...
client.on('interactionCreate', async (i) => {
  ...
  if (i.customId === 'myButton2') {
    ...
    const channel = await client.channels.fetch('1301612859712864266');/// روم منتجات
...
const roleButtonMap = [
  {
    label: "Mythic",
    emoji: "", //اموجي
    roleID: "1301612782319435798",//ايدي رتبة
  },
  {
    label: "Special S",
    emoji: "", //اموجي
    roleID: "1301612783367880725", // ايدي رتبة
  },
  {
    label: "Great S",
    emoji: "", //اموجي
    roleID: "1301612784525643788", // ايدي رتبة
  },
];
...
// توكن البوت الخاص بك
const token = 'MTMwNDc1NjAzMjczOTczNzY0MA.GsG2y4.aM_68Jze1RmbEoEq7d0yAnJ6nsP6e69WeTwO68';
